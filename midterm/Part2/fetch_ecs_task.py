...
class TaskIPs:
    ...
    mapper_ips: List[str]
    reducer_ip: str
    mapfunctional_mapper_ips: List[str]
...
class ECSTaskManager:
    ...
    async def get_mapreduce_ips(self) -> TaskIPs:
        ...
        malfunctional_mappers = self.get_tasks_by_type(tasks, "malfunctional-mapper")
        ...
        return TaskIPs(
            ...
            mapfunctional_mapper_ips=[malfunctional_mappers[0].public_ip] if malfunctional_mappers else [],
        )
